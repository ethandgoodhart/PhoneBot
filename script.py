...
#         if (similar):
#             similar = (len(arr1) - len(list(set(arr1).intersection(arr2))) <= 1)

#         print("Very Close: " + str(similar))
